            ...
            <div className="bg-white border rounded shadow p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="bg-blue-50/50 border border-blue-100 p-5 rounded-lg">
                        <h3 className="text-lg font-semibold text-blue-900 mb-3">2. Choose 5th Main (Optional Subject)</h3>
                        <p className="text-xs text-blue-700 mb-4">Marks are <strong>included</strong> in total marks and percentage.</p>
                        <select
                    ...
                    <div className="bg-amber-50/50 border border-amber-100 p-5 rounded-lg">
                        ...
                        <p className="text-xs text-amber-700 mb-4">Marks are <strong>EXCLUDED</strong> from total marks and percentage.</p>
                        <select
