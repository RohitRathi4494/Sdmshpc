                ...
                <div style={{ padding: '22px 14px 28px' }}>
                    ...
                    <div className="section" style={{ marginTop: 16 }}>
                        ...
                        <table className="foundational-table" style={{ width: '100%', borderCollapse: 'collapse', border: `1px solid ${C.navy}`, fontSize: 13, background: C.white }}>
                            <tbody>
                                <tr>
                                    <td style={{ width: '22%', background: C.rowEven, padding: '14px 12px', fontWeight: 700, color: C.navy, textAlign: 'left' }}>Student Name:</td>
                                    <td colSpan={3} style={{ padding: '14px 12px', color: C.text, textAlign: 'left' }}>{reportData.student?.student_name}</td>
                                </tr>
                                <tr>
                                    <td style={{ background: C.rowEven, padding: '14px 12px', fontWeight: 700, color: C.navy, textAlign: 'left' }}>Roll No.:</td>
                                    <td style={{ width: '28%', padding: '14px 12px', color: C.text, textAlign: 'left' }}>{reportData.student?.roll_no}</td>
                                    <td style={{ width: '15%', background: C.rowEven, padding: '14px 12px', fontWeight: 700, color: C.navy, textAlign: 'left' }}>Adm No.:</td>
                                    <td style={{ width: '35%', padding: '14px 12px', color: C.text, textAlign: 'left' }}>{reportData.student?.admission_no}</td>
                                </tr>
                                <tr>
                                    <td style={{ background: C.rowEven, padding: '14px 12px', fontWeight: 700, color: C.navy, textAlign: 'left' }}>Class / Section:</td>
                                    <td colSpan={3} style={{ padding: '14px 12px', color: C.text, textAlign: 'left' }}>{reportData.student?.class_name} {reportData.student?.section_name ? '— ' + reportData.student?.section_name : ''}</td>
                                </tr>
                                <tr>
                                    <td style={{ background: C.rowEven, padding: '14px 12px', fontWeight: 700, color: C.navy, textAlign: 'left' }}>Date of Birth:</td>
                                    <td colSpan={3} style={{ padding: '14px 12px', color: C.text, textAlign: 'left' }}>{reportData.student?.dob ? new Date(reportData.student.dob).toLocaleDateString("en-GB") : ''}</td>
                                </tr>
                                <tr>
                                    <td style={{ background: C.rowEven, padding: '14px 12px', fontWeight: 700, color: C.navy, textAlign: 'left' }}>Address:</td>
                                    <td colSpan={3} style={{ padding: '14px 12px', color: C.text, textAlign: 'left' }}>{reportData.student?.address || ''}</td>
                                </tr>
                                <tr>
                                    <td style={{ background: C.rowEven, padding: '14px 12px', fontWeight: 700, color: C.navy, textAlign: 'left' }}>Phone:</td>
                                    <td colSpan={3} style={{ padding: '14px 12px', color: C.text, textAlign: 'left' }}>{reportData.student?.phone_no || ''}</td>
                                </tr>
                                <tr>
                                    <td style={{ background: C.rowEven, padding: '14px 12px', fontWeight: 700, color: C.navy, textAlign: 'left' }}>Mother/Guardian Name:</td>
                                    <td colSpan={3} style={{ padding: '14px 12px', color: C.text, textAlign: 'left' }}>{reportData.student?.mother_name || ''}</td>
                                </tr>
                                <tr>
                                    <td style={{ background: C.rowEven, padding: '14px 12px', fontWeight: 700, color: C.navy, textAlign: 'left' }}>Father/Guardian Name:</td>
                                    <td colSpan={3} style={{ padding: '14px 12px', color: C.text, textAlign: 'left' }}>{reportData.student?.father_name || ''}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
