...
export default function ReportTemplate_III_VIII_Terminal_SDHPS({ reportData, reportType }: { reportData: ReportData, reportType: 'TA1' | 'TA2' }) {
                                        ...
                                        return (
                                            <>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colSpan={4} style={{ textAlign: 'center', fontWeight: 700, padding: '2px 4px' }}>{totalMax}</td>
