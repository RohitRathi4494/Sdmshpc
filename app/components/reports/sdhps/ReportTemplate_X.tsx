...
export default function ReportTemplate_X_SDHPS({ reportData }: { reportData: ReportData }) {
                                ...
                                <tbody>
                                    {(() => {
                                        ...
                                        const rows = reportData.subjects?.map((sub: any) => {
                                            ...
                                            const subMaxTotal = getComponentMax(sub, 'Periodic Assessment') + getComponentMax(sub, 'Subject Enrichment Activities') + getComponentMax(sub, 'Terminal Assessment');
